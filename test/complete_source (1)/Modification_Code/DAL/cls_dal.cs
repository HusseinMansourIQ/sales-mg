    ...
    class cls_dal
    {
        ...
        {//User Id=amc;Password=amc     integrated security=true
         ...
         // sqlcon = new SqlConnection(@"Server=.;Database=DB_SaleApp;Persist Security Info=true;User Id=sales;Password=sales;Max Pool Size=50000;Pooling=True");
            ...
            sqlcon = new SqlConnection(@"Server=(localdb)\MSSQLLocalDB;Database=DB_SaleApp;Integrated Security=True;Max Pool Size=50000;Pooling=True");
            sqlcon2= new SqlConnection(@"Server=(localdb)\MSSQLLocalDB;Database=master;Integrated Security=True;Max Pool Size=50000;Pooling=True");
        }
